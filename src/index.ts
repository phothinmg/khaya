...
namespace BurmeseCleandar{
    ...
    const translate = ({text,lang}: trs) =>{
      ...
      export function GetCleandarData(date:string,lang:number){
    ...
    export function WorldTimeZone(timeZoneName : string){
...
export default BurmeseCleandar;
